...
import com.tata.cuenta_movimiento.dto.*;
...
public class MovimientoController {
     ...
     */
    @GetMapping("/reportes")
    public ResponseEntity<ApiResponse<List<ReporteMovimientoView>>> getReporteMovimientos(
        ...
        List<ReporteMovimientoView> reporte = movimientoService.buscarMovimientosxClientexFecha(fechaInicio, fechaFin, clienteId);
